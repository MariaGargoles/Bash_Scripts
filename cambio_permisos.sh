...
do
	...
	#Borramos ficheros y links de versiones anteriores creados por el script nominas y contratos. Comprobamos si son ficheros o links, los eliminamos una vez hecha la comprobacion, si en la ruta no existe el fichero el mensaje de error no se mostrara por pantalla.
